...
@section('titre', 'Administration · Éditer le Rôle ' . $role->nom)
...
<div style="margin-bottom: 1.5rem;">
    ...
    <h2 style="font-family:'Space Grotesk',sans-serif;margin:.5rem 0 0;">Éditer le rôle : {{ $role->nom }}</h2>
</div>
...
<div class="carte-form">
    <form method="POST" action="{{ route('admin.roles.update', $role) }}">
        ...
        <div class="form-group">
            ...
            <input type="text" id="nom" name="nom" class="form-input" value="{{ old('nom', $role->nom) }}" required>
        </div>
        ...
        <div class="form-group">
            ...
            <textarea id="description" name="description" class="form-input" rows="3">{{ old('description', $role->description) }}</textarea>
        </div>
        ...
        <div style="margin-top: 1.75rem; margin-bottom: 1rem;">
            ...
            <p style="font-size:.82rem;color:var(--texte-att);margin:0;">Modifiez les droits d'accès associés à ce rôle.</p>
        </div>
        ...
        <div style="display:flex;justify-content:flex-end;gap:1rem;margin-top:1.5rem;">
            ...
            <button type="submit" class="btn" style="background:var(--ambre);color:var(--graphite);font-weight:600;padding:.6rem 1.25rem;border-radius:8px;border:none;">Enregistrer les modifications</button>
        </div>
    </form>
</div>
@endsection
