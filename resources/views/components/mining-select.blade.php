@props(['label' => null, 'options' => [], 'accent' => 'gold', 'error' => null])
...
<div class="space-y-2">
    ...
    <select {{ $attributes->merge(['class' => "w-full px-4 py-3 bg-charcoal-900 border $borderColor rounded-lg text-charcoal-100 transition-all $accentColor ring-0 focus:ring-2 appearance-none cursor-pointer"]) }}>
        {{ $slot }}
